...
func TestNewRootHandler(t *testing.T) {
	...
	handler := NewRootHandler("console_test", "notification_center_test", testLogger, "https://api.example.com", "1.0")
...
func TestRootHandler_ServeConfigJS(t *testing.T) {
	...
	handler := NewRootHandler("console_test", "notification_center_test", testLogger, testAPIEndpoint, "1.0")
...
func TestRootHandler_ServeNotificationCenter(t *testing.T) {
	...
	handler := NewRootHandler("console_test", tempDir, testLogger, "https://api.example.com", "1.0")
...
func TestRootHandler_ServeConsole(t *testing.T) {
	...
	handler := NewRootHandler(tempDir, "notification_center_test", testLogger, "https://api.example.com", "1.0")
