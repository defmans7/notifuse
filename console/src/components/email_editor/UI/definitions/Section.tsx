...
const SectionBlockDefinition: BlockDefinitionInterface = {
  ...
  RenderSettings: (props: BlockRenderSettingsProps) => {
    ...
    return (
      <div className="xpeditor-padding-h-l">
        ...
        >
          ...
          >
            ...
            <Radio.Button style={{ width: '25%', textAlign: 'center' }} value="justify">
              <AlignJustify size={16} style={{ marginTop: '3px' }} />
            </Radio.Button>
          </Radio.Group>
        </Form.Item>
        ...
        {/* 
            <Form.Item label="Background image" labelAlign="left" className="xpeditor-form-item-align-right" labelCol={{ span: 10 }} wrapperCol={{ span: 14 }}>
  ...
  renderMenu: (blockDefinition: BlockDefinitionInterface) => {
    return (
      <div className="xpeditor-menu-definition">
