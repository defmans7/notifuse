...
const HeadingBlockDefinition: BlockDefinitionInterface = {
  ...
  RenderSettings: (props: BlockRenderSettingsProps) => {
    ...
    console.log('props.block.data.type', props.block.data.type)
    return (
      <>
        ...
        <div className="xpeditor-ui-menu-title">{props.block.data.type} global settings</div>
  ...
  renderEditor: (props: BlockEditorRendererProps) => {
    ...
    return (
      <div style={wrapperStyles}>
        ...
        {isFocused && (
          <MyEditor
            key={props.block.data.type} // key is used to force re-render when the type changes
