  ...
  RenderSettings: (props: BlockRenderSettingsProps) => {
    ...
    return (
      <div className="xpeditor-padding-h-l">
        ...
        {/* <Form.Item label="Width" labelAlign="left" className="xpeditor-form-item-align-right" labelCol={{ span: 10 }} wrapperCol={{ span: 14 }}>
                <InputNumber
                    style={{ width: '100%' }}
        ...
        {/* <Form.Item label="Height" labelAlign="left" className="xpeditor-form-item-align-right" labelCol={{ span: 10 }} wrapperCol={{ span: 14 }}>
                <InputNumber
                    style={{ width: '100%' }}
  ...
  renderMenu: (_blockDefinition: BlockDefinitionInterface) => {
    return (
      <div className="xpeditor-ui-block">
        <Space size="middle">
          <SquareMousePointer size={16} style={{ marginTop: '5px' }} />
          Button
        </Space>
      </div>
    )
