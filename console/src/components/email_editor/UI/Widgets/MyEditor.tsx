...
const MyToolbar = (props: any) => {
  ...
  return (
    <div ref={ref} className="xpeditor-toolbar">
      ...
      {props.toolbarButtons.includes('fonts') && (
        <>
          ...
          />
          <ColorPickerLight
            className="xpeditor-toolbar-color"
            size="small"
      ...
      <div className="xpeditor-toolbar-overlay"></div>
    </div>
  )
}
...
const FormatButton = (props: { format: string; icon: React.ReactNode }) => {
  ...
  return (
    <ToolbarButton
      className="xpeditor-toolbar-button"
      reversed
...
>((props, ref) => {
  // Extract active from props to avoid passing it directly to the div element
  const { active, ...otherProps } = props

  return (
    <div {...otherProps} ref={ref} className={cn('xpeditor-toolbar-button', { active: active })} />
  )
})
...
const HyperlinkButton = (props: HoveringToolbarProps) => {
  ...
  return (
      ...
      content={
        <div>
          ...
          <p>
            ...
            />
            <b style={{ paddingRight: '12px' }}>Disable URL tracking</b>
          </p>
          <Button
            type="default"
    ...
    >
      <span
        className={cn('xpeditor-toolbar-button', { active: isActive })}
        style={{ padding: '0px 0px 0px 2px' }}
      >
        <LinkOutlined style={{ verticalAlign: 'middle', fontSize: 13 }} />
      </span>
    </Popover>
  )
}
